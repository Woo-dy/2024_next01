...
function Page(props) {
   ...
   return (
      <>
         ...
         <div style={{textAlign:"center", marginRight:"250px", margin:"0 auto"}}>
            <Button variant='contained' color='primary'>
               <Link href="/guestBookWrite" style={{textDecoration:"none", color:"#fff"}}>쓰기</Link>
            </Button>
         </div>
                           ...
                           : list.map((item) => (
                              <TableRow key={item.gb_idx}>
                                 ...
                                 <TableCell className="table-cell">
                                    <Link href={`/guestBookDetails/${item.gb_idx}`}>{item.gb_subject} {item.gb_idx}</Link>
                                 </TableCell>
                              </TableRow>
                           ))}
                  </TableBody>
